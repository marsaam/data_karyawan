...
<body>
                        ...
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                           ...
                           <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-login-2"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 8v-2a2 2 0 0 1 2 -2h7a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-7a2 2 0 0 1 -2 -2v-2" /><path d="M3 12h13l-3 -3" /><path d="M13 15l3 -3" /></svg>
                            <div class="d-none d-xl-block ps-2">
                                <div>{{ $user->name ?? '-' }}</div>
                                <div class="mt-1 small text-secondary">  {{ $user->roleRef->name ?? '-' }}</div>
                            </div>
                        </a>
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <div class="navbar">
                    <div class="container-xl">
                        <ul class="navbar-nav">
                            @can('view karyawan')
                            <li class="nav-item {{ request()->routeIs('data_karyawan') ? 'active' : '' }}">
                            ...
                            @can('view user')
                            <li class="nav-item {{ request()->routeIs('master_user') ? 'active' : '' }}">
                            ...
                            @can('view role')
                            <li class="nav-item {{ request()->routeIs('master_role') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('master_role') }}">
                                    <span
                                        class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            {{-- <li class="nav-item {{ request()->routeIs('master_akses') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('master_akses') }}">
                                    <span
                                        class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
    ...
    <!-- DataTables Bootstrap Integration (opsional) -->
